...
const TweetBox = ({ setTweets }: Props) => {
  ...
  const postTweet = async () => {
    const tweetInfo: TweetBody = {
      ...
      profileImg: session?.user?.image || "https://i.pinimg.com/474x/ec/e2/b0/ece2b0f541d47e4078aef33ffd22777e.jpg",
      image: image,
    };
  ...
  return (
    <div className="flex space-x-2 p-5">
      <img
        ...
        src={session?.user?.image || "https://i.pinimg.com/474x/ec/e2/b0/ece2b0f541d47e4078aef33ffd22777e.jpg"}
        alt=""
      />
